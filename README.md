...
### Connectivity Verification Theory:
### How an EC2 instance in the Private Subnet can successfully reach the 
...
### Why an external user on the public internet cannot directly reach or 
access that private instance. 
